...
function Clock() {
    ...
    const stringTime = (date.getHours()< 9?'0':'') + date.getHours() + ':'
        + (date.getMinutes()< 9?'0':'') + date.getMinutes()+ ':'
        + (date.getSeconds()< 9?'0':'') + date.getSeconds() || <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
